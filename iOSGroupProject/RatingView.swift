...
//
//  Thanks to Glen Yi for code (edited for our purposes)
//
...
@objc public protocol RatingViewDelegate {
     ...
     */
    func floatRatingView(_ ratingView: RatingView, didUpdate rating: Float)
    
    /**
     Returns the rating value as the user pans
     */
    @objc optional func floatRatingView(_ ratingView: RatingView, isUpdating rating: Float)
}

/**
 A simple rating view that can set float point ratings.
 */
@IBDesignable
